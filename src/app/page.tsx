  ...
  return (
    <section className="grid gap-6">
      ...
      <div className="grid md:grid-cols-3 gap-4">
        ...
        <Link href="/cubesat" className="rounded-lg bg-white/5 p-4 ring-1 ring-white/10 hover:ring-cyan-400 focus:outline-none focus:ring-2 focus:ring-cyan-400">
          <h2 className="font-semibold">Test CubeSat</h2>
        </Link>
      </div>
      <div className="rounded-lg bg-white/5 p-6 ring-1 ring-white/10">
